...
let Nucleotide = /** @class */ (() => {
    class Nucleotide {
        constructor(cm_pos, a1, a3, base, v = new THREE.Vector3(0., 0., 0.), L = new THREE.Vector3(0., 0., 0.), n3 = -1, pair = undefined, cluster = undefined, color = undefined) {
        ...
        copy(disp, rot) {
            let copy = new Nucleotide(this.cm_pos.clone(), this._a1.clone(), this._a3.clone(), this._base, this._L, this._v, this.n3, this.pair, this.cluster, this.color);
            if (disp !== undefined) {
                copy.translate(disp);
            }
            if (rot !== undefined) {
...
class System {
    constructor(box, time = 0, E_pot = 0, E_kin = 0) {
        this._time = time;
        this._ready = false;
        this._box = box;
        this._N = 0;
